...
export const buttonGold = `${buttonBase} button-shine border-gold bg-gold text-paper hover:-translate-y-0.5 hover:border-gold-bright hover:bg-gold-bright hover:text-paper hover:shadow-[0_10px_30px_rgba(217,174,60,0.22)]`;
...
export const kickerClass =
  "inline-flex items-center gap-2.5 text-[13px] font-semibold tracking-[0.2em] text-gold-deep uppercase";
