      ...
      <main className="mx-auto max-w-3xl px-5 py-12 text-paper/80 sm:px-8 sm:py-20">
        ...
        <div className="break-words text-base leading-relaxed">
          ...
          <section className={sectionClass}>
            ...
            <p>O site carrega a tag do Google Ads em todas as visitas para medir tentativas de contato pelo formulário ou botão de WhatsApp. Antes de você decidir, e também se você recusar, a tag opera em modo restrito: não grava cookies de publicidade, não utiliza identificadores para criar perfil e envia ao Google apenas uma medição agregada, com redução de dados de anúncios ativada. Ao aceitar, passam a ser utilizados cookies de medição. Essa medição não confirma envio de mensagem, atendimento ou contratação. Em nenhuma dessas situações o código transmite os campos do formulário ou o endereço da mensagem do WhatsApp ao Google.</p>
            <p>Após o aceite, a tag pode tratar identificadores de publicidade, cookies como _gcl_aw, endereço IP e informações técnicas do navegador. Sem o aceite, permanecem o endereço IP e informações técnicas do navegador inerentes à requisição, sem cookies de publicidade. Esses dados são destinados ao Google para medição publicitária e podem ser processados fora do Brasil. Não habilitamos Google Analytics, personalização de anúncios ou conversões otimizadas nesta integração. Consulte também a <a href="https://policies.google.com/privacy?hl=pt-BR" className="text-gold-bright underline" target="_blank" rel="noopener noreferrer">política de privacidade do Google</a>.</p>
